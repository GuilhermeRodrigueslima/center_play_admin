...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen flex" style={{ background: '#0a0a0a', fontFamily: 'sans-serif' }}>
      <aside style={{ width: '240px', minHeight: '100vh', background: '#111', borderRight: '1px solid #222', display: 'flex', flexDirection: 'column', position: 'fixed', top: 0, left: 0, zIndex: 50 }}>
        ...
        <nav style={{ flex: 1, padding: '16px 0' }}>
          ...
          <Link href="/admin/devices" style={{ display: 'flex', alignItems: 'center', gap: '10px', padding: '12px 20px', color: '#ccc', textDecoration: 'none', fontSize: '0.9rem' }}>
